 ...
 ============================================================================================================================-->
   <section class="main-heading" id="home">
       <div class="overlay">
        ...
        <h1 class="main-heading-title"><span class="main-element themecolor" data-elements="Prilims,Mains,Interview"></span></h1>
        <p class="main-heading-text">Mission</p>
        <div class="btn-bar">
          <a href="{{url('/register')}}" class="btn btn-custom theme_background_color">Get Started</a>
          <a href="{{url('/login')}}" class="btn btn-custom-outline">Login</a>
        </div>
      </div>
               </div>
           </div>
...
At the center of Amma’s life is her darshan: the tender, caring embrace that has been sought out by millions. It is in this intimate manner—a heartfelt hug—that Mata Amritanandamayi meets one and all, listens to their problems and gives them the inspiration and knowledge to uplift themselves and, ultimately, others.==================================================================================================-->
         ...
         <div class="row about-box">
          <div class="col-sm-4 text-center">
            <div class="margin-bottom">
              ...
              <p class="black">To provide the best possible coaching facilities for preparing our aspirants to confidently and successfully appear for the Civil Services Exam (preliminary and main)</p>
							</img>
						</div> <!-- / margin -->
          </div> <!-- /col -->
          ...
          <div class="col-sm-4 text-center">
            <div class="margin-bottom">
              ...
              <p class="black">To help transform our aspirants into world class administrators who would be morally and ethically upright and perform their duties fearlessly with compassion and a spirit of service.</p>
            </div> <!-- / margin -->
          </div><!-- /col -->
        </div> <!-- /row -->
 ...
 ============================================================================================================================-->
  ...
  <!-- [OUR TEAM]
 ============================================================================================================================-->
  <section class="recent-works text-center" id="three">
      <div class="container">
